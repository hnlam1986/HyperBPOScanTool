...
namespace NTwain.Data
{
    ...
    public sealed partial class TWCapability : IDisposable
    {
        ...
        void SetOneValue(TWOneValue value, IMemoryManager memoryManager)
        {
            ...
            if (TypeExtensions.GetItemTypeSize(value.ItemType) > 4) { throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "Type {0} is not valid for TWOneValue.", "TWOneValue")); }
        ...
        void SetRangeValue(TWRange value, IMemoryManager memoryManager)
        {
            ...
            if (TypeExtensions.GetItemTypeSize(value.ItemType) > 4) { throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "Type {0} is not valid for TWRange.", "TWRange")); }
    ...
    public partial class TWIdentity
    {
            ...
            string manufacturer, string productFamily, string productName, string productDescription)
        {
            ...
            {
                throw new ArgumentException("Application must support Image or Audio data groups for AppId.");
            }
    ...
    /// <summary>
    /// This structure is used to tell the application how many more complete transfers the Source currently has
    /// available.
    /// </summary>
